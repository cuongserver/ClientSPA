...
export const cacheLang = localStorage.getItem('displayLanguage') && availableLang.includes(localStorage.getItem('displayLanguage') as string) ? (localStorage.getItem('displayLanguage') as string) : 'vi'
